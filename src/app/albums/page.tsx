...
import fetchAlbums from "../../../utils/albums/fetchAlbums";
import PoppingLetters from '../components/general/poppingLetters';
import AlbumForm from '../components/albums/albumModal';
...
export default function Albums() {
    ...
    return (
        <div className='flex flex-col w-full h-full items-center bg-pink-200'>
            <SignInForm />
            <Header />
                        ...
                        <div className="flex flex-row">
                            ...
                            <div className='xs:ml-2 sm:ml-4 w-full'>
                                <div className='w-full flex flex-row justify-between'>
                                    <p className="xs:text-xl sm:text-4xl xl:text-6xl text-black">{album.name}</p>
